            ...
            <div className="flex-1 flex flex-col">
              ...
              {selectedCommand === 'ppt' && (
                <div className="p-4 border-t border-slate-700 bg-slate-850 flex gap-4">
                  ...
                  <button 
                    onClick={() => window.open(`https://www.bing.com/images/create?prompt=Minh họa+giáo+dục+${encodeURIComponent(tenBai || monHoc || 'bài học')}+môn+${encodeURIComponent(monHoc)}+lớp+${encodeURIComponent(khoiLop)}+đẹp+thẩm+mỹ+sư+phạm`, '_blank')}
